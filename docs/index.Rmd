...
- Las diapositivas del curso están disponibles aquí: [UPDATE]
- Encuentre el código fuente de este sitio web en GitHub: [UPDATE]
...
#### 2. Modelo variable en el tiempo: un sexo
...
#### 3. Modelo variable en el tiempo: dos sexos
